...
* add (pt-br) translation for system settings. ([77211c4](https://github.com/wish-oss/puter/commit/77211c4f71b0285fb3060f7e5c8d493b4d7c4f0c))
* add /group/list endpoint ([d55f38c](https://github.com/wish-oss/puter/commit/d55f38ca68899c3574cfe328d2b206b1143ff0d4))
...
* add group management endpoints ([4216346](https://github.com/wish-oss/puter/commit/4216346384d90dcba429dbcb175e6f86482d19f4))
* add group permission endpoints ([c374b0c](https://github.com/wish-oss/puter/commit/c374b0cbca761e7c8a47d56a09551f2e9378066a))
...
* add service to test file share logic ([332371f](https://github.com/wish-oss/puter/commit/332371fccb198462948a440419adc7a26d671a23))
...
* add user-group permission check ([0014940](https://github.com/wish-oss/puter/commit/00149402e041443aa3ac571fbe97a9a85f95564b))
* add vietnamese localization-a ([c2d3d69](https://github.com/wish-oss/puter/commit/c2d3d69dbe33f36fcae13bcbc8e2a31a86025af9))
* **backend:** Add tab completion to server console command arguments ([fa81dca](https://github.com/wish-oss/puter/commit/fa81dca9507b7fa0f82099b75f2ab89c865626ac))
* **backend:** Add tab-completion to server console command names ([e1e76c6](https://github.com/wish-oss/puter/commit/e1e76c6be71fdeb3b6246307b626734d8dc26f86))
* Display app icon and description in embeds ([ef298ce](https://github.com/wish-oss/puter/commit/ef298ce3aa3ce90224e883fb0ba33f9cd3a3da44))
* get first test working on share-test service ([88d6bee](https://github.com/wish-oss/puter/commit/88d6bee9546f36d689c53ec7fe95f01f772f5211))
* **git:** Add --color and --no-color options ([d6dd1a5](https://github.com/wish-oss/puter/commit/d6dd1a5bb0a2b2bba2cfe86d2e51ff2a6e42841c))
* **git:** Add a --debug option, which sets the DEBUG global ([fa3df72](https://github.com/wish-oss/puter/commit/fa3df72f6ed2d45a440ebc2aacbbae67bf042478))
* **git:** Add authentication to clone, fetch, and pull. ([364d580](https://github.com/wish-oss/puter/commit/364d580ff896691ee70d3735f495c720651a9f41))
* **git:** Add diff display to `show` and `log` subcommands ([3cad1ec](https://github.com/wish-oss/puter/commit/3cad1ec436f99a78f782ab9576325d4341284964))
* **git:** Add start-revision and file arguments to `git log` ([49c2f16](https://github.com/wish-oss/puter/commit/49c2f163515d2130c17a6f6a6a16bc27ea69336a))
* **git:** Allow checking out a commit instead of a branch ([057b3ac](https://github.com/wish-oss/puter/commit/057b3acf00af49c005b9bf7069c5d22983a32e1e))
* **git:** Color output for `git status` files ([bab5204](https://github.com/wish-oss/puter/commit/bab5204209aa2efc0c053643677a78db6ede0929))
* **git:** Display file contents as a string for `git show FILE_OID` ([a680371](https://github.com/wish-oss/puter/commit/a68037111a04580cfa2688694a68ef6ac7a495fa))
* **git:** Display ref names in `git log` and `git show` ([45cdfcb](https://github.com/wish-oss/puter/commit/45cdfcb5bfa66937b33054a127e0b17001f3faa4))
* **git:** Format output closer to canonical git ([60976b1](https://github.com/wish-oss/puter/commit/60976b1ed61984d9d290f3a0ae99dd97632e9909))
* **git:** Handle detached HEAD in `git status` and `git branch --list` ([2c9b1a3](https://github.com/wish-oss/puter/commit/2c9b1a3ffc3d5e282ffe5b83a86314e99445bbc6))
* **git:** Implement `git branch` ([ad4f132](https://github.com/wish-oss/puter/commit/ad4f13255d52f8226f22800c16b388cf0e6384d7))
* **git:** Implement `git checkout` ([35e4453](https://github.com/wish-oss/puter/commit/35e4453930bc4e151887f83c97efec19cc15da70))
* **git:** Implement `git cherry-pick` ([2e4259d](https://github.com/wish-oss/puter/commit/2e4259d267b3cfafd5cefc57a02643c6432fec4d))
* **git:** Implement `git clone` ([95c8235](https://github.com/wish-oss/puter/commit/95c8235a4a1fea39a46c40df04cb1004a2fe7b23))
* **git:** Implement `git diff` ([622b6a9](https://github.com/wish-oss/puter/commit/622b6a9b921c3c03efc0b519c9a26c6701d80e50))
* **git:** Implement `git fetch` ([98a4b9e](https://github.com/wish-oss/puter/commit/98a4b9ede39b94c0c6b6b8345d7551359961186a))
* **git:** Implement `git pull` ([eb2b6a0](https://github.com/wish-oss/puter/commit/eb2b6a08b03cee0612885412cd4b03c9564044e3))
* **git:** Implement `git push` ([8c70229](https://github.com/wish-oss/puter/commit/8c70229a188b743220db076a740a992fd7971301))
* **git:** Implement `git remote` ([43ce0d5](https://github.com/wish-oss/puter/commit/43ce0d5b45d4eb4f296afcaaa1ecadc125c53e89))
* **git:** Implement `git restore` ([4ba8a32](https://github.com/wish-oss/puter/commit/4ba8a32b45d395f28433572db5644d630776789e))
* **git:** Make `git add` work for deleted files ([9551544](https://github.com/wish-oss/puter/commit/955154468f48e45028dad2e916708d6a763affad))
* **git:** Make shorten_hash() guaranteed to produce a unique hash ([dd10a37](https://github.com/wish-oss/puter/commit/dd10a377493c0d8f10a1ac8779dc27f3f3bf6c37))
* **git:** Resolve more forms of commit reference ([b6906bb](https://github.com/wish-oss/puter/commit/b6906bbcaaa50fc8a8c60beb6d2d38bcb7dda758))
* **git:** Understand references like `HEAD^` and `main~3` ([711dbc0](https://github.com/wish-oss/puter/commit/711dbc0d2fde9c2ddc6c86f64fb4caa7837c9dcb))
...
* JSON support for kv driver ([3ed7916](https://github.com/wish-oss/puter/commit/3ed7916856f03eafbe0891f2ab39c34d20d2bd24))
...
* **phoenix:** Make `clear` clear scrollback unless `-x` is given ([75a989a](https://github.com/wish-oss/puter/commit/75a989a7b69bfdfdf69e5f0365027c5b27d8bfc6))
* **phoenix:** Show actual host name in prompt and neofetch ([4539408](https://github.com/wish-oss/puter/commit/4539408a218a50244dc615cf7de56c29dcac53e6))
* rate-limit for excessive groups ([4af279a](https://github.com/wish-oss/puter/commit/4af279a72fc9de89ddc3ba51806ca3760a36265d))
* register dev center to apps ([10f4d7d](https://github.com/wish-oss/puter/commit/10f4d7d50ce9314f9c3888c74cb17c8ebbecee98))
...
* support canonical puter.js url in dev ([fd41ae2](https://github.com/wish-oss/puter/commit/fd41ae217c7a9f7229326f62a829471580a744bd))
* update BR translation ([42a6b39](https://github.com/wish-oss/puter/commit/42a6b3938a588b8b4d1bd976c37e9c6e58408c75))
...
* add missing columns for public directory update ([b10302a](https://github.com/wish-oss/puter/commit/b10302ad744fd9c58f9735743e075815183c772c))
...
* bug introduced when refactoring /share to Sequence ([ecb9978](https://github.com/wish-oss/puter/commit/ecb997885c1efb766827c84d2ffb8dc6ddabe992))
* column nullability blunder ([1429d6f](https://github.com/wish-oss/puter/commit/1429d6f57c67dff51fc41ca0c2868f8d000845f1))
* disable unconfigured ai services ([476acae](https://github.com/wish-oss/puter/commit/476acae0e0d07c7b025cdbcfd86aacfedd7831a5))
* docker runtime fail because stdout columns ([94c0449](https://github.com/wish-oss/puter/commit/94c0449437ce4cb26d00a15a3f277bc7b09367b4))
...
* fix owner ids for default apps ([283f409](https://github.com/wish-oss/puter/commit/283f409a662d126e7f3ce811f1467ac6fab9a522))
...
* **git:** Make git commit display detached HEAD correctly ([73d0f5a](https://github.com/wish-oss/puter/commit/73d0f5a90cb5dcbadfc6d0fd22f14e8bc0e61f86))
* group permission audit table ([7d2f6d2](https://github.com/wish-oss/puter/commit/7d2f6d256f56e30d752e9999c6e8bde68f9d9637))
* handling of batch requests with zero files ([c0063a8](https://github.com/wish-oss/puter/commit/c0063a871fd891a1774f1bee00e86170fed249fa))
...
* **phoenix:** Gracefully handle completing a non-existent path ([d76e713](https://github.com/wish-oss/puter/commit/d76e7130cba9f0ca05940abafe4fd1a41464aa83))
...
* property validation on some permission endpoints ([0855f2b](https://github.com/wish-oss/puter/commit/0855f2b36eca3bbdaa8429cbde3aa1242e8e96ee))
...
* ui color input attributes ([d9c4fbb](https://github.com/wish-oss/puter/commit/d9c4fbbd1dcce12ee05ee33652a5fa518196463d))
* update email share object ([9033f6f](https://github.com/wish-oss/puter/commit/9033f6f8c74ef8739294d640ac1c7eba95519bbd))
* update PD alert custom details ([2f16322](https://github.com/wish-oss/puter/commit/2f163221bdde09425cae11ef7f8e4eb0b10c7103))
